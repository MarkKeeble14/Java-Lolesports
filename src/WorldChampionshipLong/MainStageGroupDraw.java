...
public class MainStageGroupDraw extends DrawStructure {
	...
	public void Simulate(List<Group> groups, List<Pool> pools) throws Exception {
		...
		// Draw Teams From Pool Four
		A.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 0, new ArrayList<Team>()));
		B.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 1, new ArrayList<Team>()));
		C.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 2, new ArrayList<Team>()));
		D.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 3, new ArrayList<Team>()));
		A.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 0, new ArrayList<Team>()));
		B.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 1, new ArrayList<Team>()));
		C.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 2, new ArrayList<Team>()));
		D.Add(P4.DrawWithSameRegionRule(pools, 0, groups, 3, new ArrayList<Team>()));
