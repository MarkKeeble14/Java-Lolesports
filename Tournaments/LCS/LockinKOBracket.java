...
public class LockinKOBracket extends Bracket {
	...
	public LockinKOBracket(Tournament partOf, String fedTeamsThrough) {
		super(partOf, fedTeamsThrough);
		// TODO Auto-generated constructor stub
	}
	public LockinKOBracket(Tournament partOf) {
		super(partOf);
		// TODO Auto-generated constructor stub
	}
	@Override
	public void Simulate(String label, List<Group> groups) throws Exception {
		...
		Series M1 = new Series(Strings.Concat(Strings.BasicBridgeWSpace, label, Strings.QFS), "M1", 3, tracker);
		Series M2 = new Series(Strings.Concat(Strings.BasicBridgeWSpace, label, Strings.QFS), "M2", 3, tracker);
		Series M3 = new Series(Strings.Concat(Strings.BasicBridgeWSpace, label, Strings.QFS), "M3", 3, tracker);
		Series M4 = new Series(Strings.Concat(Strings.BasicBridgeWSpace, label, Strings.QFS), "M4", 3, tracker);
