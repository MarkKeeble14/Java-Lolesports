...
public class CurrentStateOfTournamentWorldChampionship extends Tournament {
	...
	public void Simulate(List<Pool> pools) throws Exception {
		...
		// Setting up groups
		Group A = new Group(Strings.LFirstGroup, 4, 3, 1, MGroupStage, Teams.DK, Teams.FPX, Teams.RGE, Teams.C9); 
		Group B = new Group(Strings.LSecondGroup, 4, 3, 1, MGroupStage, Teams.EDG, Teams.T1, Teams.O100T, Teams.DFM);
		Group C = new Group(Strings.LThirdGroup, 4, 3, 1, MGroupStage, Teams.FNC, Teams.RNG, Teams.HLE, Teams.PSG); 
		Group D = new Group(Strings.LFourthGroup, 4, 3, 1, MGroupStage, Teams.TL, Teams.MAD, Teams.LNG, Teams.GEN);
