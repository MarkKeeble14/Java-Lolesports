...
public class PIStageGroupStage extends GroupStage {
	...
	public void Simulate(List<Group> groups) throws Exception {
		...
		standings.PlaceTeam(A.GetTeamFromPlacement(7), 28);
		standings.PlaceTeam(B.GetTeamFromPlacement(7), 28);
		standings.PlaceTeam(A.GetTeamFromPlacement(6), 26);
		standings.PlaceTeam(B.GetTeamFromPlacement(6), 26);
	...
	public void SetQualified(List<Group> groups, List<Team> teams) {
		...
		Team Q5 = teams.get(4);
		Q5.setNewQD(new QualifiedThroughGroupPlacement(Strings.PIGS, A, 5));
		
		Team Q6 = teams.get(4);
		Q6.setNewQD(new QualifiedThroughGroupPlacement(Strings.PIGS, B, 1));
		Team Q7 = teams.get(5);
		Q7.setNewQD(new QualifiedThroughGroupPlacement(Strings.PIGS, B, 2));
		Team Q8 = teams.get(6);
		Q8.setNewQD(new QualifiedThroughGroupPlacement(Strings.PIGS, B, 3));
		Team Q9 = teams.get(7);
		Q9.setNewQD(new QualifiedThroughGroupPlacement(Strings.PIGS, B, 4));
		Team Q10 = teams.get(7);
		Q10.setNewQD(new QualifiedThroughGroupPlacement(Strings.PIGS, B, 5));
	}
}
